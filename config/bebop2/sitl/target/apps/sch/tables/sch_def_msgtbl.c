...
SCH_MessageEntry_t SCH_DefaultMessageTable[SCH_MAX_MESSAGES] =
{
   ...
   /* Command ID #86 */
   { { SCH_FIX_HEADER(NEOM8N_MEASURE_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #87 */
   ...
   { { SCH_FIX_HEADER(SCH_UNUSED_MID, 0, 0), 0 } },
   /* Command ID #96 */
   { { SCH_FIX_HEADER(PRM_SEND_HK_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #97 */
   { { SCH_FIX_HEADER(PRM_WAKEUP_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #98 */
   { { SCH_FIX_HEADER(SCH_UNUSED_MID, 0, 0), 0 } },
   /* Command ID #99 */
   { { SCH_FIX_HEADER(CAMIO_SEND_HK_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #100 */
   { { SCH_FIX_HEADER(CAMIO_ACQUIRE_IMAGE_MID, 0xC000, 0x0001), 0x0000 } },
   /* Command ID #101 */
   { { SCH_FIX_HEADER(SCH_UNUSED_MID, 0, 0), 0 } },
   /* Command ID #102 */
